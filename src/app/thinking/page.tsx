...
export const metadata: Metadata = {
  title: 'Thinking | Issei Suzuki\'s Portfolio',
  description: 'Issei Suzukiの思考やアイデア、技術に対する考察を綴ったページです。',
}
    ...
    <PageBackground showBubbles={false}>
      <div className="container mx-auto px-4 py-12">
        <section className="text-center mb-12">
          <h1 className="text-4xl font-bold text-primary mb-4">💭 Thinking</h1>
              ...
              <Card key={index} className="hover:shadow-xl transition-all duration-300">
                <div className="card-body">
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                    <h2 className="card-title text-xl text-primary">{thought.title}</h2>
